...
const EditEvent = () => {
    ...
    const [data, setData] = useState({ tk: '', location_tk: '', text_tk: '', en: '', location_en: '', text_en: '', ru: '', location_ru: '', text_ru: '', image: '', date: '', link: '' });
    ...
    const handleSubmit = async (e:React.FormEvent) => {
        ...
        try {
            ...
            await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/upcoming/${id}`,
            ...
            router.push(`/admin/events/view-event/${id}`);
        } catch (err) {
            console.error(err);
                                ...
                                <div className="tab-content bg-base-100 border-base-300 p-6">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setData((prev) => ({ ...prev, location_tk: e.target.value }))}
                                            className="border border-gray-300 rounded p-2 w-full"
                                        />
                                    </div>
                                    <div className="mb-4">
                                ...
                                <div className="tab-content bg-base-100 border-base-300 p-6">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setData((prev) => ({ ...prev, location_en: e.target.value }))}
                                            className="border border-gray-300 rounded p-2 w-full"
                                        />
                                    </div>
                                    <div className="mb-4">
                                ...
                                <div className="tab-content bg-base-100 border-base-300 p-6">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setData((prev) => ({ ...prev, location_ru: e.target.value }))}
                                            className="border border-gray-300 rounded p-2 w-full"
                                        />
                                    </div>
                                    <div className="mb-4">
