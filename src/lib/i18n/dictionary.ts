...
export const dictionary = {
    ...
    'common.prev': { ru: 'Предыдущее', en: 'Previous' },
    'common.next': { ru: 'Следующее', en: 'Next' },
    'common.zoomIn': { ru: 'Приблизить', en: 'Zoom in' },
    'common.zoomOut': { ru: 'Отдалить', en: 'Zoom out' },
    ...
    'form.startDate': { ru: 'Дата начала', en: 'Start date' },
    'form.endDate': { ru: 'Дата окончания', en: 'End date' },
    'form.endDateHint': {
        ru: 'Можно не заполнять — сайт посчитает её из длительности тура',
        en: 'Optional — the site works it out from the tour duration',
    },
    'form.priceHint': {
        ru: 'Пусто — действует цена тура',
        en: 'Empty means the tour price applies',
    },
    'form.seatsLeft': { ru: 'Осталось мест', en: 'Seats left' },
    'form.seatsHint': {
        ru: 'Пусто — места не считаем. Ноль — мест нет',
        en: 'Empty means seats are not counted. Zero means none left',
    },
    'form.status': { ru: 'Состояние', en: 'Status' },
    'form.sortOrder': { ru: 'Порядок', en: 'Order' },
    'form.sortOrderHint': {
        ru: 'Меньше число — выше в списке. Самый сильный довод ставьте первым',
        en: 'Lower number comes first. Put the strongest point at the top',
    },
    'dep.open': { ru: 'Открыт', en: 'Open' },
    'dep.sold_out': { ru: 'Мест нет', en: 'Sold out' },
    'dep.closed': { ru: 'Набор закрыт', en: 'Closed' },
    'dep.duplicate': {
        ru: 'На эту дату у тура уже есть заезд',
        en: 'This tour already has a departure on that date',
    },
    'req.departure': { ru: 'Заезд', en: 'Departure' },

    'form.destination': { ru: 'Маршрут', en: 'Route' },
    'form.destinationHint': {
        ru: 'Города через тире: Ашхабад – Дарваза – Мары',
        en: 'Cities separated by dashes: Ashgabat – Darvaza – Mary',
    },
    'form.duration': { ru: 'Продолжительность', en: 'Duration' },
    'form.durationHint': { ru: 'Число дней', en: 'Number of days' },
    'form.lang': { ru: 'Языки', en: 'Languages' },
    'form.langHint': { ru: 'Через запятую', en: 'Comma separated' },
    'form.sectionBasics': { ru: 'Основное', en: 'Basics' },
    'form.sectionImages': { ru: 'Картинки', en: 'Images' },
    'form.sectionTexts': { ru: 'Тексты', en: 'Texts' },
    'form.sectionTextsHint': {
        ru: 'Заполните все три языка: сайт показывает перевод того языка, который выбрал посетитель',
        en: 'Fill in all three languages: the site shows the visitor the language they picked',
    },
    'form.notSet': { ru: 'Не выбрано', en: 'Not selected' },
    'form.replaceImage': { ru: 'Заменить файл. Не выбран — остаётся прежний', en: 'Replace the file. None chosen — the current one stays' },
