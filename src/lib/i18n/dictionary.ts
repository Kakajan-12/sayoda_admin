...
export const dictionary = {
    ...
    "set.hours.label": { ru: "Часы работы офиса", en: "Office hours" },
    "set.hours.hint": { ru: "Формат «Mo-Fr 09:00-18:00»: дни двумя буквами по-английски, время через дефис. Из этой строки собирается разметка для поиска, а на сайте дни выводятся на языке посетителя.", en: "Format: “Mo-Fr 09:00-18:00” — two-letter English day codes and a time range. The site turns this into search markup and shows the days in the visitor’s language." },
    "set.err.hours": { ru: "Похоже на неверный формат. Сохранится, но в разметку для поиска не попадёт — на странице строка покажется как есть.", en: "This does not look like the expected format. It will be saved, but it will not go into the search markup — the page will show it as typed." },
    "set.response.label": { ru: "Отвечаем в течение, часов", en: "Reply within, hours" },
    "set.response.hint": { ru: "Число. Обещание видно на странице контактов, поэтому ставьте срок, который выдержите в худший день, а не в лучший.", en: "A number. The promise is shown on the contact page, so use a figure you can keep on a bad day, not a good one." },
    "set.langs.label": { ru: "Языки гидов", en: "Guide languages" },
    "set.langs.hint": { ru: "Коды через запятую: en, ru, tk, tr. Названия языков сайт выведет сам на языке посетителя.", en: "Comma-separated codes: en, ru, tk, tr. The site renders the language names in the visitor’s own language." },
    "set.err.langs": { ru: "Ожидаются двухбуквенные коды через запятую, например «en,ru,tk».", en: "Expected two-letter codes separated by commas, for example “en,ru,tk”." },
    "set.team.label": { ru: "Человек в команде", en: "People on the team" },
    "set.team.hint": { ru: "Число. Пусто — блок на странице «О нас» не выводится.", en: "A number. Leave empty and the figure is hidden on the About page." },
    "set.travellers.label": { ru: "Принято туристов", en: "Travellers hosted" },
    "set.travellers.hint": { ru: "Число. Пишите настоящее: это проверяемое утверждение, а не украшение.", en: "A number. Use the real one — this is a checkable claim, not decoration." },
    "nav.group.hotels": { ru: "Отели", en: "Hotels" },
    "nav.hotels": { ru: "Отели", en: "Hotels" },
    "nav.cities": { ru: "Города", en: "Cities" },
    "cities.intro": { ru: "Справочник городов. Город привязан к стране, а отель — к городу: страна у отеля берётся отсюда, отдельно её указывать не нужно.", en: "A directory of cities. A city belongs to a country and a hotel belongs to a city, so a hotel’s country comes from here." },
    "cities.empty": { ru: "Пока ни одного города. Добавьте город, чтобы завести в нём отели.", en: "No cities yet. Add one before you can create hotels in it." },
    "cities.name": { ru: "Название", en: "Name" },
    "cities.newItem": { ru: "Новый город", en: "New city" },
    "cities.addItem": { ru: "Добавить город", en: "Add a city" },
    "cities.country": { ru: "Страна", en: "Country" },
    "cities.needName": { ru: "Заполните название хотя бы на одном языке", en: "Fill in the name in at least one language" },
    "cities.needCountry": { ru: "Выберите страну", en: "Choose a country" },
    "cities.added": { ru: "Город добавлен", en: "City added" },
    "cities.hotelsCount": { ru: "отелей", en: "hotels" },
    "cities.err.load": { ru: "Ошибка при загрузке городов", en: "Could not load the cities" },
    "cities.err.save": { ru: "Не удалось сохранить", en: "Could not save" },
    "cities.err.delete": { ru: "Не удалось удалить", en: "Could not delete" },
    "hotels.intro": { ru: "Отели по городам. Пока у отеля не заполнена ссылка на бронирование, кнопка на сайте не показывается.", en: "Hotels grouped by city. The booking button stays hidden on the site until the booking link is filled in." },
    "hotels.empty": { ru: "Пока ни одного отеля. Раздел на сайте не выводится, пока он пуст.", en: "No hotels yet. The section stays hidden on the site while it is empty." },
    "hotels.newItem": { ru: "Новый отель", en: "New hotel" },
    "hotels.addItem": { ru: "Добавить отель", en: "Add a hotel" },
    "hotels.city": { ru: "Город", en: "City" },
    "hotels.name": { ru: "Название", en: "Name" },
    "hotels.address": { ru: "Адрес", en: "Address" },
    "hotels.stars": { ru: "Категория", en: "Star rating" },
    "hotels.starsNone": { ru: "Не указана", en: "Not set" },
    "hotels.starsHint": { ru: "Категория отеля, а не оценка гостей. Пусто — звёзды на карточке не показываются.", en: "The hotel’s official class, not a guest score. Leave empty to hide the stars on the card." },
    "hotels.amenities": { ru: "Удобства", en: "Amenities" },
    "hotels.included": { ru: "Входит в цену", en: "Included in the price" },
    "hotels.breakfast": { ru: "Завтрак", en: "Breakfast" },
    "hotels.kidsPlayArea": { ru: "Детская площадка", en: "Kids play area" },
    "hotels.parking": { ru: "Парковка", en: "Parking" },
    "hotels.wifi": { ru: "Wi-Fi", en: "Wi-Fi" },
    "hotels.travelTax": { ru: "Туристический сбор", en: "Travel tax" },
    "hotels.bookUrl": { ru: "Ссылка на бронирование", en: "Booking link" },
    "hotels.bookUrlHint": { ru: "Полный адрес вместе с https://. Пусто — кнопки не будет.", en: "Full address including https://. Leave empty to hide the button." },
    "hotels.image": { ru: "Фотография", en: "Photo" },
    "hotels.imageKeep": { ru: "Оставить прежнюю", en: "Keep the current one" },
    "hotels.needName": { ru: "Заполните название хотя бы на одном языке", en: "Fill in the name in at least one language" },
    "hotels.needCity": { ru: "Выберите город", en: "Choose a city" },
    "hotels.noCities": { ru: "Сначала заведите хотя бы один город в разделе «Города».", en: "Add at least one city in the Cities section first." },
    "hotels.added": { ru: "Отель добавлен", en: "Hotel added" },
